...
namespace SnesEmulator.Hardware
{
    ...
    public class InstructionsDecodeTable
    {
        ...
        private void LoadKnownInstructions()
        {
            ...
            // EOR
            RegisterKnownInstruction(0x41, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndexedIndirect));
            RegisterKnownInstruction(0x43, new InstructionEOR(cpu, Hardware.AddressingModes.StackRelative));
            RegisterKnownInstruction(0x45, new InstructionEOR(cpu, Hardware.AddressingModes.Direct));
            RegisterKnownInstruction(0x47, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndirectLong));
            RegisterKnownInstruction(0x49, new InstructionEOR(cpu, Hardware.AddressingModes.ImmediateMemoryFlag));
            RegisterKnownInstruction(0x4D, new InstructionEOR(cpu, Hardware.AddressingModes.Absolute));
            RegisterKnownInstruction(0x4F, new InstructionEOR(cpu, Hardware.AddressingModes.AbsoluteLong));
            RegisterKnownInstruction(0x51, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndirectIndexed));
            RegisterKnownInstruction(0x52, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndirect));
            RegisterKnownInstruction(0x53, new InstructionEOR(cpu, Hardware.AddressingModes.StackRelativeIndirectIndexed));
            RegisterKnownInstruction(0x55, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndexedX));
            RegisterKnownInstruction(0x57, new InstructionEOR(cpu, Hardware.AddressingModes.DirectIndirectIndexedLong));
            RegisterKnownInstruction(0x59, new InstructionEOR(cpu, Hardware.AddressingModes.AbsoluteIndexedY));
            RegisterKnownInstruction(0x5D, new InstructionEOR(cpu, Hardware.AddressingModes.AbsoluteIndexedX));
            RegisterKnownInstruction(0x5F, new InstructionEOR(cpu, Hardware.AddressingModes.AbsoluteIndexedLong));
            ...
            // LDX
            Action<Instruction, int, int> operation_LDX = (Instruction sender, int p1, int p2) =>
            {
                CPU_LoadInto(ref cpu.X, sender.ResolveArgument(p1));
            };

            RegisterKnownInstruction(0xA2, GenericInstCustom(Hardware.OpCodes.LDX, Hardware.AddressingModes.ImmediateMemoryFlag, operation_LDX,
                (GenericInstruction.DecodeArgumentsFunctionDelegate)delegate(GenericInstruction sender, Memory.MemoryBin bin, ref InstructionDecodeContext context, ref int offset, ref int p1, ref int p2)
                {
                    p1 = sender.DecodeI1I2ArgumentForXFlag(bin, ref offset, ref context);
                }));
            RegisterKnownInstruction(0xA6, GenericInst(Hardware.OpCodes.LDX, Hardware.AddressingModes.Direct, operation_LDX, ArgumentType.I1));
            RegisterKnownInstruction(0xAE, GenericInst(Hardware.OpCodes.LDX, Hardware.AddressingModes.Absolute, operation_LDX, ArgumentType.I2));
            RegisterKnownInstruction(0xB6, GenericInst(Hardware.OpCodes.LDX, Hardware.AddressingModes.DirectIndexedY, operation_LDX, ArgumentType.I1));
            RegisterKnownInstruction(0xBE, GenericInst(Hardware.OpCodes.LDX, Hardware.AddressingModes.AbsoluteIndexedY, operation_LDX, ArgumentType.I2));

            // LDY
            Action<Instruction, int, int> operation_LDY = (Instruction sender, int p1, int p2) =>
            {
                CPU_LoadInto(ref cpu.Y, sender.ResolveArgument(p1));
            };

            RegisterKnownInstruction(0xA0, GenericInstCustom(Hardware.OpCodes.LDY, Hardware.AddressingModes.ImmediateMemoryFlag, operation_LDY,
                (GenericInstruction.DecodeArgumentsFunctionDelegate)delegate(GenericInstruction sender, Memory.MemoryBin bin, ref InstructionDecodeContext context, ref int offset, ref int p1, ref int p2)
                {
                    p1 = sender.DecodeI1I2ArgumentForXFlag(bin, ref offset, ref context);
                }));
            RegisterKnownInstruction(0xA4, GenericInst(Hardware.OpCodes.LDY, Hardware.AddressingModes.Direct, operation_LDY, ArgumentType.I1));
            RegisterKnownInstruction(0xAC, GenericInst(Hardware.OpCodes.LDY, Hardware.AddressingModes.Absolute, operation_LDY, ArgumentType.I2));
            RegisterKnownInstruction(0xB4, GenericInst(Hardware.OpCodes.LDY, Hardware.AddressingModes.DirectIndexedX, operation_LDY, ArgumentType.I1));
            RegisterKnownInstruction(0xBC, GenericInst(Hardware.OpCodes.LDY, Hardware.AddressingModes.AbsoluteIndexedX, operation_LDY, ArgumentType.I2));
            ...
            // ORA
            RegisterKnownInstruction(0x01, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndexedIndirect));
            RegisterKnownInstruction(0x03, new InstructionORA(cpu, Hardware.AddressingModes.StackRelative));
            RegisterKnownInstruction(0x05, new InstructionORA(cpu, Hardware.AddressingModes.Direct));
            RegisterKnownInstruction(0x07, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndirectLong));
            RegisterKnownInstruction(0x09, new InstructionORA(cpu, AddressingModes.ImmediateMemoryFlag));
            RegisterKnownInstruction(0x0D, new InstructionORA(cpu, Hardware.AddressingModes.Absolute));
            RegisterKnownInstruction(0x0F, new InstructionORA(cpu, Hardware.AddressingModes.AbsoluteLong));
            RegisterKnownInstruction(0x11, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndirectIndexed));
            RegisterKnownInstruction(0x12, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndirect));
            RegisterKnownInstruction(0x13, new InstructionORA(cpu, Hardware.AddressingModes.StackRelativeIndirectIndexed));
            RegisterKnownInstruction(0x15, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndexedX));
            RegisterKnownInstruction(0x17, new InstructionORA(cpu, Hardware.AddressingModes.DirectIndirectIndexedLong));
            RegisterKnownInstruction(0x19, new InstructionORA(cpu, Hardware.AddressingModes.AbsoluteIndexedY));
            RegisterKnownInstruction(0x1D, new InstructionORA(cpu, Hardware.AddressingModes.AbsoluteIndexedX));
            RegisterKnownInstruction(0x1F, new InstructionORA(cpu, Hardware.AddressingModes.AbsoluteIndexedLong));
            ...
            // REP
            RegisterKnownInstruction(0xC2, GenericInst(Hardware.OpCodes.REP, Hardware.AddressingModes.ImmediateMemoryFlag, (sender, p1, p2) => { cpu.P = (byte)(cpu.P & (((1 << 8) - 1) ^ p1)); }, ArgumentType.I1));
            ...
            // SBC
            RegisterKnownInstruction(0xE1, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndexedIndirect));
            RegisterKnownInstruction(0xE3, new InstructionSBC(cpu, Hardware.AddressingModes.StackRelative));
            RegisterKnownInstruction(0xE5, new InstructionSBC(cpu, Hardware.AddressingModes.Direct));
            RegisterKnownInstruction(0xE7, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndirectLong));
            RegisterKnownInstruction(0xE9, new InstructionSBC(cpu, AddressingModes.ImmediateMemoryFlag));
            RegisterKnownInstruction(0xED, new InstructionSBC(cpu, Hardware.AddressingModes.Absolute));
            RegisterKnownInstruction(0xEF, new InstructionSBC(cpu, Hardware.AddressingModes.AbsoluteLong));
            RegisterKnownInstruction(0xF1, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndirectIndexed));
            RegisterKnownInstruction(0xF2, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndirect));
            RegisterKnownInstruction(0xF3, new InstructionSBC(cpu, Hardware.AddressingModes.StackRelativeIndirectIndexed));
            RegisterKnownInstruction(0xF5, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndexedX));
            RegisterKnownInstruction(0xF7, new InstructionSBC(cpu, Hardware.AddressingModes.DirectIndirectIndexedLong));
            RegisterKnownInstruction(0xF9, new InstructionSBC(cpu, Hardware.AddressingModes.AbsoluteIndexedY));
            RegisterKnownInstruction(0xFD, new InstructionSBC(cpu, Hardware.AddressingModes.AbsoluteIndexedX));
            RegisterKnownInstruction(0xFF, new InstructionSBC(cpu, Hardware.AddressingModes.AbsoluteIndexedLong));
            ...
            // SEP
            RegisterKnownInstruction(0xE2, GenericInst(Hardware.OpCodes.SEP, Hardware.AddressingModes.ImmediateMemoryFlag, (sender, p1, p2) => { cpu.P = (byte)(cpu.P & p1); }, ArgumentType.I1));
...
#warning DEBUG
            ...
            // TAX
            RegisterKnownInstruction(0xAA, GenericInst(Hardware.OpCodes.TAX, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.X, cpu.ACC); }));

            // TAY
            RegisterKnownInstruction(0xA8, GenericInst(Hardware.OpCodes.TAY, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.Y, cpu.ACC); }));

            // TCD
            RegisterKnownInstruction(0x5B, GenericInst(Hardware.OpCodes.TCD, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.D, (short)cpu.ACC); }));
           
            // TCS
            RegisterKnownInstruction(0x1B, GenericInst(Hardware.OpCodes.TCS, Hardware.AddressingModes.Implied, (sender, p1, p2) => { cpu.SP = cpu.ACC; }));
           
            // TDC
            RegisterKnownInstruction(0x7B, GenericInst(Hardware.OpCodes.TDC, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.ACC, cpu.D); }));
            ...
            // TSC
            RegisterKnownInstruction(0x3B, GenericInst(Hardware.OpCodes.TSC, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.ACC, cpu.SP); }));

            // TSX
            RegisterKnownInstruction(0xBA, GenericInst(Hardware.OpCodes.TSX, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.X, cpu.SP); }));

            // TXA
            RegisterKnownInstruction(0x8A, GenericInst(Hardware.OpCodes.TXA, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.ACC, cpu.X); }));
                      
            // TXS
            RegisterKnownInstruction(0x9A, GenericInst(Hardware.OpCodes.TXS, Hardware.AddressingModes.Implied, (sender, p1, p2) => { cpu.SP = cpu.X; }));
           
            // TXY
            RegisterKnownInstruction(0x9B, GenericInst(Hardware.OpCodes.TXY, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.Y, cpu.X); }));
            
            // TYA
            RegisterKnownInstruction(0x98, GenericInst(Hardware.OpCodes.TYA, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.ACC, cpu.Y); }));

            // TYX
            RegisterKnownInstruction(0xBB, GenericInst(Hardware.OpCodes.TYX, Hardware.AddressingModes.Implied, (sender, p1, p2) => { CPU_LoadInto(ref cpu.X, cpu.Y); }));
        ...
        private void CPU_LoadInto(ref short target_register, short value)
        {
