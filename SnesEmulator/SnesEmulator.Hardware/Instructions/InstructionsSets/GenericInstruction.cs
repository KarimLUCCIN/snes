...
namespace SnesEmulator.Hardware.Instructions.InstructionsSets
{
    public class GenericInstruction : Instruction
    {
        ...
        public delegate void DecodeArgumentsFunctionDelegate(GenericInstruction sender, Memory.MemoryBin bin, ref InstructionDecodeContext context, ref int offset, ref int param1, ref int param2);
